...
export class PsychObject extends EventEmitter {
  ...
  _setAttribute(
    ...
    if (
      ...
      this.hasOwnProperty("_" + attributeName)
    ) {
      ...
      if (
        ...
        (Array.isArray(attributeValue) &&
          (attributeValue.length === 0 || typeof attributeValue[0] == "number"))
      ) {
        // value is an array:
    ...
    return (
      prev === "Object (circular)" ||
      next === "Object (circular)" ||
      prev !== next
    );
  }
